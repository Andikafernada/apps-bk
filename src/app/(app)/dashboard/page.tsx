            ...
            {cases.slice(0, 5).map(caseItem => (
              <div key={caseItem.id} className="flex items-center gap-4">
                <Avatar className="hidden h-9 w-9 sm:flex">
                  <AvatarImage src={placeholderImages.find(p => p.id === caseItem.studentAvatarId)?.imageUrl} alt="Avatar" data-ai-hint="student avatar" />
                  <AvatarFallback>{caseItem.studentName.charAt(0)}</AvatarFallback>
                </Avatar>
